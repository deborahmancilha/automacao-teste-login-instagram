...
public class informacoesUsuarioTest {
    ...
    public void testLogin() {
        ...
        //Digitar no campo com name "username" que está dentro do label de class "f0n8F" o texto "contateste_0102"
        formularioSignInBox.findElement(By.name("username")).sendKeys("contateste_0102");

        //Digitar no campo com name "password" o texto "Teste0102"
